...
const TRANSLATIONS = {
  ar: {
    ...
    // INTRO
    who_tag: 'من نحن',
    who_title: 'متخصصون في توريد وتركيب أنظمة الزجاج والألمنيوم في الإمارات',
    who_p1: 'جلازورا لبيع الأبواب والنوافذ ذ.م.م. شركة متخصصة في توريد وتركيب الأبواب والنوافذ وأنظمة الواجهات الزجاجية، تأسست في المنطقة الصناعية الحيل بالفجيرة.',
    who_p2: 'نعمل مع موردين موثوقين لتقديم منتجات عالية الجودة من الألمنيوم والزجاج والـ UPVC والـ WPC، مع تنفيذ دقيق وخدمة سريعة في مختلف أنحاء الإمارات.',
    who_btn: 'قصتنا ←',
    ...
    prod_curtain: 'الواجهات الزجاجية (Curtain Wall)',
    ...
    prod_handrail: 'الدرابزينات',
    prod_handrail_desc: 'درابزينات وحواجز من الفولاذ المقاوم للصدأ والألمنيوم والزجاج',
    prod_gates: 'بوابات السور',
    prod_gates_desc: 'بوابات ألمنيوم وحديد للمداخل والمباني السكنية والتجارية',
    ...
    why_1_title: 'موردون موثوقون',
    why_1_desc: 'نتعاون مع موردين معتمدين لضمان جودة المواد في كل مشروع — بدون وسطاء غير ضروريين.',
    ...
    why_3_desc: 'من القياس الأول حتى التسليم النهائي، ندير التوريد والتوصيل والتركيب بنقطة اتصال واحدة.',
    ...
    footer_rights: '© 2026 جلازورا. جميع الحقوق محفوظة.',
    ...
    // ABOUT
    about_tag: 'من نحن',
    about_title: 'انطلقنا من الفجيرة،\nنخدم الإمارات',
    about_sub: 'متخصصون في توريد وتركيب أنظمة الألمنيوم والزجاج والـ UPVC والـ WPC — مع التزام بالجودة والشفافية.',
    story_tag: 'قصتنا',
    story_title: 'من الفجيرة إلى كل زاوية في الإمارات',
    story_p1: 'تأسست جلازورا لبيع الأبواب والنوافذ ذ.م.م. في المنطقة الصناعية الحيل بالفجيرة. نتخصص في توريد وتركيب أنظمة الأبواب والنوافذ والواجهات الزجاجية، بالتعاون مع موردين موثوقين لضمان جودة عالية في كل مشروع.',
    story_p2: 'فريقنا من المتخصصين في التركيب وخدمة العملاء يفهم متطلبات بيئة البناء في الإمارات: الحرارة الشديدة، والهواء المالح، والرمال، وجداول المشاريع الضيقة.',
    story_btn: 'اتصل بنا ←',
    val_tag: 'قيمنا',
    val_title: 'المبادئ التي تقود كل مشروع',
    val_quality: 'الجودة أولاً',
    val_quality_desc: 'كل منتج نوفره ونركبه يخضع للمعايير الدولية ومتطلبات السوق الإماراتي.',
  ...
  en: {
    ...
    who_p1: "Glazora for Doors and Windows Sales LLC is a specialist supplier and installer of doors, windows, and glazed facade systems, based in Fujairah's AlHail Industrial Zone.",
    who_p2: "We work with trusted suppliers to deliver high-quality aluminum, glass, UPVC, and WPC products — with precise installation and fast service across all seven Emirates.",
    who_btn: 'Our Story →',
    ...
    prod_tag: 'What We Offer', prod_title: 'Our Product Range', prod_view_all: 'View All Products →',
    ...
    prod_handrail: 'Handrails', prod_handrail_desc: 'Stainless steel, aluminum & glass balustrades and barriers',
    prod_gates: 'Gates', prod_gates_desc: 'Aluminum and steel gates for entrances, villas, and commercial buildings',
    ...
    why_1_title: 'Trusted Suppliers', why_1_desc: 'We partner with certified suppliers to ensure material quality on every project — no unnecessary middlemen.',
    ...
    why_3_title: 'End-to-End Service', why_3_desc: 'From first measurement to final handover, we manage supply, delivery, and installation with one point of contact.',
    ...
    footer_about: 'About Us', footer_contact: 'Contact', footer_rights: '© 2026 Glazora. All rights reserved.',
    ...
    about_tag: 'About Glazora', about_title: 'From Fujairah,\nServing the UAE',
    about_sub: 'A specialist supplier and installer of aluminum, glass, UPVC, and WPC architectural systems.',
    story_tag: 'Our Story', story_title: 'From Fujairah to Every Corner of the UAE',
    story_p1: 'Glazora for Doors and Windows Sales LLC was established in the AlHail Industrial Zone of Fujairah. We specialize in the supply and installation of doors, windows, and glazed facade systems, working with trusted suppliers to deliver consistent quality on every project.',
    story_p2: 'Our team of installation specialists and project coordinators understands the UAE construction environment: extreme heat, salt air, sand, and tight project timelines — and we deliver accordingly.',
    story_btn: 'Contact Us →',
    val_tag: 'Our Values', val_title: 'The Principles That Guide Every Project',
    val_quality: 'Quality First', val_quality_desc: 'Every product we supply and install meets international standards and UAE market requirements.',
    ...
    visit_label: 'Visit Us', visit_val: 'AlHail Industrial Zone,\nFujairah, UAE',
